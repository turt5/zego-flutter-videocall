...
import 'package:zego_videocalling/pages/_home.dart';
...
class _SecondPageState extends State<SecondPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      resizeToAvoidBottomInset: true, // Ensure the view resizes when the keyboard appears
      body: SafeArea(
                      ...
                      Navigator.of(context).push(
                        CupertinoPageRoute(
                          builder: (context) => HomePage(
                            ...
                            roomId: generateRandom12DigitNumber(),
                          ),
                        ),
                      );
                    }else{
                        ...
                        SnackBar(
                          content: Row(
                            children: [
                              ...
                              Text('Name Cannot be empty!', style: GoogleFonts.inter(fontWeight: FontWeight.bold,color: Colors.white)),
                            ],
                          ),
  ...
  int generateRandom12DigitNumber() {
